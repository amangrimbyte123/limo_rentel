...
const promises = [
  {
    ...
    desc: "Your safety is our top priority. Our vehicles are meticulously maintained and our chauffeurs are highly trained professionals.",
  },
  {
    icon: <FaStar className="text-[var(--primary)] text-3xl mb-2 drop-shadow-lg" />,
    title: "Luxury Experience",
    desc: "Enjoy a seamless, first-class journey in our premium fleet, designed for comfort and style on every ride.",
  },
  {
    icon: <FaClock className="text-[var(--primary)] text-3xl mb-2 drop-shadow-lg" />,
    title: "Punctuality",
    desc: "We value your time. Expect prompt arrivals and timely service, every single time you book with us.",
  },
  {
    icon: <FaSmile className="text-[var(--primary)] text-3xl mb-2 drop-shadow-lg" />,
    title: "Customer Delight",
    desc: "Our team goes above and beyond to ensure your satisfaction, making every occasion memorable.",
  },
];
